...
#if !defined(APPLY_ENV_MODULATE_COLOR)
# if defined(APPLY_RGB_DISTANCERAMP) || defined(APPLY_RGB_CONST) || defined(APPLY_RGB_VERTEX) || defined(APPLY_RGB_ONE_MINUS_VERTEX)
# define APPLY_ENV_MODULATE_COLOR
# endif
#endif
...
#if defined(APPLY_VERTEX_LIGHTING) && defined(APPLY_ENV_MODULATE_COLOR)
# undef APPLY_ENV_MODULATE_COLOR
#endif
